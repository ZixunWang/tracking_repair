...
class OTBDataset(BaseDataset):
    ...
    def __init__(self, **kwargs):
        ...
        if 'perturbation' not in kwargs:
            self.base_path = os.path.join(self.env_settings.otb_path, 'test')
        else:
            self.base_path = os.path.join(self.env_settings.otb_path, 'test.{}'.format(construct_suffix(kwargs['perturbation'])))
